      ...
      <div className="max-w-7xl w-full mx-auto px-6 flex flex-col justify-center h-full">
        ...
        <div className="flex items-center gap-1.5 mb-6">
          <div className="flex -space-x-2">
            <img className="w-8 h-8 rounded-full border-2 border-black object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100" alt="User" />
            <img className="w-8 h-8 rounded-full border-2 border-black object-cover" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100" alt="User" />
            <img className="w-8 h-8 rounded-full border-2 border-black object-cover" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100" alt="User" />
          </div>
          <div className="flex flex-col">
            <div className="flex text-amber-500">
              {[...Array(5)].map((_, i) => <Star key={i} className="w-3 h-3 fill-amber-500" />)}
            </div>
            <span className="text-[10px] text-neutral-400 font-medium tracking-wide">Choice of fitness freaks</span>
          </div>
        </div>
